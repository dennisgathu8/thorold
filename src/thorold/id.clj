...
(defn reep-id
  "Generates a stable Reep ID for the given entity type and canonical seed.
   ...
   COMPATIBILITY WARNING: IDs generated by this function will NOT match existing
   IDs in people.csv or teams.csv. Existing IDs were randomly minted using UUID4
   and are not reproducible from seeds. This function is for NEW entity ID
   generation only. To work with existing entities, always use the reep_id value
   read directly from the source CSV — never regenerate it from a QID seed."
  [type seed]
